...
def agent_system_prompt(
    ...
    *,
    ...
    return (
        ...
        "  hit the live DB.'\n"
        "  In cache-only mode, every tool whose entire purpose is a live-DB query is HIDDEN\n"
        "  from your menu — list_catalogs, list_server_databases, list_volumes, list_databases,\n"
        "  check_uniqueness, detect_dimensional_role, detect_scd_pattern, sample_column_values,\n"
        "  inspect_data_quality, find_joinable_tables, find_joinable_across_profiles. If a\n"
        "  question genuinely needs one of them, do NOT pretend; tell the user 'this needs\n"
        "  live data, enable Live refresh in the composer and ask again.' For freshness\n"
        "  questions, call catalog_sync_status — it works without Live refresh.\n"
