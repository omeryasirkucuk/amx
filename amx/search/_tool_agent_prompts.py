...
def agent_system_prompt(
    ...
    *,
    ...
    return (
        ...
        "  * coverage / 'how many tables don't have comments' → catalog_coverage_summary\n"
        "  * inventory / 'which databases / schemas do I have' → catalog_inventory\n"
        "  * single-column / 'what type is X' / 'is Y nullable' → describe_column\n"
        "  * sync state / 'is my catalog fresh' / 'when did we sync' → catalog_sync_status\n"
        "  Each returns the full answer from one SQLite read. Quote the numbers; do NOT\n"
        "  chain describe_table / list_tables_in_schema afterwards 'just to be sure'.\n"
