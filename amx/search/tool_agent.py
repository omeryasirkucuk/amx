...
def _agent_system_prompt(
    ...
    *,
    ...
    return (
        ...
        "  'açıklamasını yaz', 'iş tanımı nedir', 'why does X exist', 'what is the\n"
        "  KPI definition') → schema metadata is rarely enough on its own. Call\n"
        ...
        "  customers written', 'which job populates orders', 'kodda nerede\n"
        "  kullanılıyor', 'hangi ETL bunu üretiyor', 'read-write callsites for X')\n"
